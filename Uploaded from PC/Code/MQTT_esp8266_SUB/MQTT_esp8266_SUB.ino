...
#define DHTPIN 10 // old version used pin 4
...
void loop() {
  ...
  if (millis() - lastMsg > 30000) {
    ...
    if (newData) {
      ...
      client.publish("Unit 1/Humidity", p_humid);
      client.publish("Unit 1/Temperature", p_temp);
      //client.publish("Unit 1/HeatIndex", p_hIndex);
